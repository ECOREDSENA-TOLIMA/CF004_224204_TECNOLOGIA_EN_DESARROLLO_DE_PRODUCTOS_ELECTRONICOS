  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mt-4
      .col-12.col-lg-8.align-self-center
        p Los circuitos son el resultado de la organización lógica y funcional de los componentes electrónicos que los conforman. Esta organización no es aleatoria debido a que depende de la determinación de especificaciones y del uso de herramientas de <em>hardware y software</em> para su elaboración. En el diseño electrónico se parte de la solución de una necesidad con la cual se genera la idea para iniciar el diseño.  
    ...
    TabsA.color-acento-botones.mt-5
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Planos esquemáticos")
        ...
        p.mt-3 Las uniones eléctricas se representan con trazos de línea vertical y horizontal y se emplean etiquetas para nombrar los componentes electrónicos y sus consecutivos. En la figura 8 se puede observar un plano esquemático de un circuito para el control de velocidad de un motor.
        ...
        figure.mt-3
          img(src="@/assets/template/tema-2-3.svg", alt="La figura 8 contiene un plano esquemático de un circuito para el control de velocidad de un motor.")
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Características")
        ...
        figure
          img(src="@/assets/template/tema-2-9.svg", alt="La figura 9 contiene una imagen de un plano esquemático de un circuito para el control de motores.") 
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Lectura de planos electrónicos")
        ...
        figure
          img(src="@/assets/template/tema-2-4.svg", alt="La figura 10 contiene la imagen de un plano esquemático de un circuito amplificador de señal.")
      ...
      .col-
        ...
        LineaTiempoD.color-primario
          ...
          .row(numero="2" titulo="Hacer uso")
            ...
            .col-11
              p De las hojas de datos o <i>datasheet</i> suministradas por los fabricantes de los componentes electrónicos utilizados en la construcción del esquemático; esto permite la identificación de aquellos elementos electrónicos que no sean reconocidos a partir de su símbolo.
