...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mt-4
      .col-12.col-lg-8
        p Las ordenes de trabajo representan el paso preliminar a la elaboración y ejecución de una tarea. Son documentos que contienen los lineamientos, especificaciones y orientaciones a tener en cuenta para la realización de una actividad. Cuando se habla de una orden de trabajo en procesos de diseño electrónico, estas deben contener descritas las tareas y especificaciones del proceso a realizar.
        .bloque-texto-a.color-primario-invertido.p-4.p-md-3.mt-4 
          .row.m-0.align-items-center.justify-content-between
            .col-lg-8
              .bloque-texto-a__texto.p-4
                p.mb-0 Las ordenes de trabajo son muy variadas y depende del área en el que se utilice, contendrán actividades relacionadas. Existen ordenes de trabajo para diseño electrónico, ordenes de trabajo para realización de mantenimiento electrónico, ordenes de trabajo para prototipado mecánico ensamble electrónico, desensamble electrónico, entre otras.
